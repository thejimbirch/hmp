...
// Search page setup
// (uncomment lines with plumbing_storage_set_array2() calls if you want to override the relevant settings from Theme Options)
...
plumbing_storage_set_array( 'options_meta', 'blog_style', 'masonry_3' );

// Sidebar position:
// Replace last parameter with one of values: none | left | right
plumbing_storage_set_array( 'options_meta', 'sidebar_position', 'none' );
