...
if ( ! function_exists( 'plumbing_trx_addons_add_theme_vars' ) ) {
	add_filter( 'plumbing_filter_add_theme_vars', 'plumbing_trx_addons_add_theme_vars', 10, 2 );
	function plumbing_trx_addons_add_theme_vars( $rez, $vars ) {
...
if ( ! function_exists( 'plumbing_trx_addons_get_css' ) ) {
	add_filter( 'plumbing_filter_get_css', 'plumbing_trx_addons_get_css', 10, 2 );
	function plumbing_trx_addons_get_css( $css, $args ) {
...
.sidebar .widget .trx_addons_tabs .trx_addons_tabs_titles li a {
	color: {$colors['extra_bg_color']};
	background-color: {$colors['bg_color']};
}
.sidebar .widget .trx_addons_tabs .trx_addons_tabs_titles li.ui-state-active a,
.sidebar .widget .trx_addons_tabs .trx_addons_tabs_titles li a:hover {
	color: {$colors['bg_color']};
	background-color: {$colors['extra_bg_color']};
}
...
.sc_testimonials.sc_testimonials_default .slider_outer .slider_pagination_wrap .swiper-pagination-bullet {
	background-color: {$colors['input_text']};
}
.sc_testimonials.sc_testimonials_default .slider_outer .slider_pagination_wrap .swiper-pagination-bullet-active,
.sc_testimonials.sc_testimonials_default .slider_outer .slider_pagination_wrap .swiper-pagination-bullet:hover {
	background-color: {$colors['extra_bg_color']};
}
...
/* Action */
.sc_action_item .sc_action_item_subtitle {						color:{$colors['text_dark']}; }
...
.sc_price_intro .sc_price_item_subtitle {
	color: {$colors['text_light']};
}
...
.sc_price_intro .sc_price_item .sc_price_item_title,
.sc_price_intro .sc_price_item .sc_price_item_title a {
	color: {$colors['text_hover2']};
}
...
.sc_price_intro .sc_price_item_link.sc_button {
...
.sc_price.sc_price_default .sc_item_descr {
	color: {$colors['text_light']};
}
...
/* Team */
.post-type-archive-cpt_team .content {
	background-color: {$colors['bg_color']};
}
.sc_team.sc_team_default .sc_item_descr {
	color: {$colors['text_light']};
}
...
.sc_team_default .sc_team_item .sc_team_item_info .sc_team_item_socials{
	background-color: {$colors['bg_color']};
}
...
/* Login and Register */
.sc_layouts_popup,
.scheme_self.sc_layouts_popup,
.sc_layouts_panel,
.scheme_self.sc_layouts_panel,
.trx_addons_popup,
.scheme_self.trx_addons_popup {
	background-color: {$colors['bg_color']};
	border-color: {$colors['alter_bd_color']};
	color: {$colors['alter_text']};
}
