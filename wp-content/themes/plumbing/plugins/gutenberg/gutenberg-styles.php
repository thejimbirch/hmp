...
if ( ! function_exists( 'plumbing_gutenberg_add_theme_vars' ) ) {
	add_filter( 'plumbing_filter_add_theme_vars', 'plumbing_gutenberg_add_theme_vars', 10, 2 );
	function plumbing_gutenberg_add_theme_vars( $rez, $vars ) {
		return $rez;
	}
}
...
if ( ! function_exists( 'plumbing_gutenberg_get_css' ) ) {
	add_filter( 'plumbing_filter_get_css', 'plumbing_gutenberg_get_css', 10, 2 );
	function plumbing_gutenberg_get_css( $css, $args ) {
