...
if (!empty($show_cart)) {
	...
	?><div<?php if (!empty($args['id'])) echo ' id="'.esc_attr($args['id']).'"'; ?> class="sc_layouts_cart<?php
		...
		<span class="sc_layouts_item_icon sc_layouts_cart_icon sc_icons_type_icons trx_addons_icon-basket"><span class="sc_layouts_cart_items_short"><?php echo esc_html($cart_items); ?></span></span>
		...
		<div class="sc_layouts_cart_widget widget_area">
			...
			// Show preview Cart
				...
				?><div class="sc_layouts_cart_preview"><?php esc_html_e('Placeholder for Cart items', 'plumbing'); ?></div><?php
			}
			?>
