...
Please install and activate it before starting to use the theme Plumbing.
...
Theme documentation is available on http://plumbing.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Plumbing is Fontello.
