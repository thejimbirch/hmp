...
if ( ! function_exists( 'plumbing_customizer_get_css' ) ) {

	function plumbing_customizer_get_css( $args = array() ) {
		...
		if ( $fonts ) {
			...
			$fonts = plumbing_customizer_add_theme_fonts( $fonts );
...
.plumbing_tabs .plumbing_tabs_titles li a {
...
CSS;
			$rez          = apply_filters( 'plumbing_filter_get_css', $rez, array( 'fonts' => $fonts ) );
			$css['fonts'] = $rez['fonts'];
		}
		...
		if ( $vars ) {
			...
			// Make theme-specific fonts rules
			$vars = plumbing_customizer_add_theme_vars( $vars );
			extract( $vars );
...
CSS;
			$rez          = apply_filters( 'plumbing_filter_get_css', $rez, array( 'vars' => $vars ) );
			$css['vars']  = $rez['vars'];
		}
		...
		//--------------------------------------
		if ( false !== $colors ) {
			$schemes = empty( $scheme ) ? array_keys( plumbing_get_sorted_schemes() ) : array( $scheme );
			...
			if ( count( $schemes ) > 0 ) {
				...
				foreach ( $schemes as $s ) {
					// Prepare colors
					if ( empty( $scheme ) ) {
						$colors = plumbing_get_scheme_colors( $s );
					}
...
h1 a:hover em, h2 a:hover em, h3 a:hover em, h4 a:hover em, h5 a:hover em, h6 a:hover em,
li a:hover em,
h1 a:hover b, h2 a:hover b, h3 a:hover b, h4 a:hover b, h5 a:hover b, h6 a:hover b,
li a:hover b,
...
table:not(.woocommerce-grouped-product-list) > tbody > tr:nth-child(2n) > td {
	background-color: {$colors['alter_bg_color']};
}
table > tbody > tr.woocommerce-cart-form__cart-item:nth-child(2n) > td  {
	background-color: {$colors['extra_bg_hover']};
}
table th a:hover {
	color: {$colors['extra_dark']};
...
.wp-caption-overlay .wp-caption .wp-caption-dd {
	...
	background: {$colors['extra_link']} !important;
}
figure figcaption a {
	color: {$colors['text_dark']};
}
...
.wpcf7-checkbox .wpcf7-list-item-right,
...
rs-module .wpcf7 div.wpcf7-response-output {
	color: {$colors['inverse_link']};
}
#rev_slider_2_1_wrapper rs-module .wpcf7 div.wpcf7-response-output {
	color: {$colors['text']};
}
...
.woocommerce-page table.shop_table .shipping .button {
	color: {$colors['inverse_link']};
	border-color: {$colors['text_link']};
	background-color: {$colors['text_link']};
}
...
.sc_layouts_row_type_narrow .search_wrap.search_style_fullscreen .search_submit:before {
	color: {$colors['inverse_link']};
}
.sc_layouts_row_type_narrow .search_style_fullscreen.search_opened .search_submit:before {
	color: {$colors['text_dark']};
}
.sc_layouts_row_type_narrow .search_wrap.search_style_fullscreen .search_submit:hover:before {
	color: {$colors['text_link']};
}
...
.woocommerce .sidebar .button:focus {
	color: {$colors['extra_dark']};
	background-color: {$colors['extra_bg_color']};
}
...
.woocommerce .product div:not(.yith_buttons_wrap) > .compare:hover {
	color: {$colors['inverse_link']};
	border-color: {$colors['text_link']};
	background-color: {$colors['text_link']};
}
.woocommerce-page table.shop_table .shipping .button:hover {
	color: {$colors['text_link']};
	border-color: {$colors['text_link']};
	background-color: transparent;
}
...
.woocommerce input.button.disabled:hover, .woocommerce input.button:disabled:hover, .woocommerce input.button[disabled]:disabled:hover {
	background: {$colors['extra_link2']} !important;
...
.sc_layouts_panel_close:hover .sc_layouts_panel_close_icon:before,
.sc_layouts_panel_close:hover .sc_layouts_panel_close_icon:after,
...
.sc_layouts_row_type_narrow.sc_layouts_row_fixed_on {
	background-color: {$colors['text_hover2']};
}
...
.top_panel .sc_layouts_login_menu .menu-item:not(.menu-item-has-children) .trx_addons_login_link span {
	color: inherit;
}
.top_panel .sc_layouts_login_menu .menu-item:not(.menu-item-has-children) .trx_addons_login_link:hover {
	color: {$colors['text_link']}!important;
	background-color: transparent;
	border-color: {$colors['text_link']};
}
...
.sc_layouts_menu_nav > li li > a {
	border-bottom-color: {$colors['extra_dark_01']};
}
...
.sc_layouts_cart .sc_layouts_item_icon:hover {
	color: {$colors['text']};
}
...
.plumbing_tabs .plumbing_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
.mptt-navigation-tabs li.active a,
.plumbing_tabs .plumbing_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}

.sheme_self.sidebar .mptt-navigation-tabs li a,
.sheme_self.sidebar .plumbing_tabs .plumbing_tabs_titles li a {
	color: {$colors['alter_dark']};
	background-color: {$colors['alter_bg_hover']};
}
.sheme_self.sidebar .mptt-navigation-tabs li a:hover,
.sheme_self.sidebar .plumbing_tabs .plumbing_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['alter_link']};
}
.sheme_self.sidebar .mptt-navigation-tabs li.active a,
.sheme_self.sidebar .plumbing_tabs .plumbing_tabs_titles li.ui-state-active a {
...
.widget .trx_addons_tabs .post_info .post_info_item a,
.widget .trx_addons_tabs .post_info .post_info_item {
	color: {$colors['text_light']};
	background-color: transparent;
}
...
.widget .trx_addons_tabs .post_info .post_info_item a:hover {
	color: {$colors['text_dark']};
	background-color: transparent;
}
.widget .trx_addons_tabs .post_info_counters .post_meta_item {
	background-color: transparent;
}
.related_wrap.related_style_classic .post_meta .post_meta_item:hover {
	color: {$colors['text_link']};
}
...
.widget_media_video .mejs-container .mejs-controls {
    background: {$colors['extra_bg_color_07']} !important;
}
...
.scheme_self.sidebar .widget_calendar .wp-calendar-nav .wp-calendar-nav-prev a,
.scheme_self.sidebar .widget_calendar .wp-calendar-nav .wp-calendar-nav-next a {
	color: {$colors['alter_link']};
}
...
.scheme_self.sidebar .widget_calendar .wp-calendar-nav .wp-calendar-nav-prev a:hover,
.scheme_self.sidebar .widget_calendar .wp-calendar-nav .wp-calendar-nav-next a:hover {
	color: {$colors['alter_hover']};
}
...
.content .widget_calendar .wp-calendar-nav .wp-calendar-nav-prev a:before,
.content .widget_calendar .wp-calendar-nav .wp-calendar-nav-next a:before {
	background-color: {$colors['bg_color']};
}
.footer_wrap .widget_calendar .wp-calendar-nav .wp-calendar-nav-prev a:before,
.footer_wrap .widget_calendar .wp-calendar-nav .wp-calendar-nav-next a:before {
	background-color: {$colors['extra_link2']};
}
...
.sc_recent_news .post_meta a:hover {
	color: {$colors['text_link']};
	background-color: transparent;
}
...
.twenty20 .twentytwenty-container .twentytwenty-overlay .twentytwenty-before-label,
.twenty20 .twentytwenty-container .twentytwenty-overlay .twentytwenty-after-label {
    color: {$colors['text_dark']};
    background-color: {$colors['alter_bg_color']};
}
...
CSS;
					...
					$rez            = apply_filters(
						'plumbing_filter_get_css', $rez, array(
							'colors' => $colors,
							'scheme' => $s,
						)
					);
		...
		return apply_filters( 'plumbing_filter_prepare_css', $css_str, $remove_spaces );
	}
}
