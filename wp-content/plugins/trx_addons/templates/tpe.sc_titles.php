...
if (settings.subtitle) {
	var subtitle_align = settings.subtitle_align !== undefined && settings.subtitle_align !== 'none' ? ' sc_align_'+settings.subtitle_align : title_align;
	subtitle_html += '<h6 class="' + subtitle_class + subtitle_align + title_style + '">'
					+ trx_addons_prepare_macros(settings.subtitle)
					+ '</h6>';
}
if (settings.subtitle_position == 'above') title_html += subtitle_html;
if (settings.title) {
