...
// Same function as trx_addons_meta_box_get duplicated for envato purposes
if (!function_exists('trx_addons_post_box_get')) {
    function trx_addons_post_box_get($post_type) {
        global $TRX_ADDONS_STORAGE;
        return isset($TRX_ADDONS_STORAGE["meta_box_{$post_type}"]) ? $TRX_ADDONS_STORAGE["meta_box_{$post_type}"] : array();
    }
}
