...
if ( !function_exists( 'trx_addons_sc_icons_load_scripts_front' ) ) {
	...
	function trx_addons_sc_icons_load_scripts_front() {
		if (trx_addons_is_on(trx_addons_get_option('debug_mode'))){
			wp_enqueue_style( 'trx-addons-sc-icons', trx_addons_get_file_url(TRX_ADDONS_PLUGIN_SHORTCODES . 'icons/icons.css'), array(), null );
		}
	}
}
...
if ( !function_exists( 'trx_addons_sc_icons_load_responsive_styles' ) ) {
	...
	function trx_addons_sc_icons_load_responsive_styles() {
		if (trx_addons_is_on(trx_addons_get_option('debug_mode'))) {
			wp_enqueue_style( 'trx-addons-sc-icons-responsive', trx_addons_get_file_url(TRX_ADDONS_PLUGIN_SHORTCODES . 'icons/icons.responsive.css'), array(), null );
		}
	}
}
