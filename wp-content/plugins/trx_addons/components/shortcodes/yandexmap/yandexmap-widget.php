...
if ( ! class_exists('TRX_Addons_SOW_Widget') ) {
	...
	class TRX_Addons_SOW_Widget_Yandexmap extends TRX_Addons_Widget {
		...
		function form($instance) {
			...
			do_action('trx_addons_action_before_widget_fields', $instance, 'trx_addons_sow_widget_yandexmap', $this);
			...
			do_action('trx_addons_action_after_widget_title', $instance, 'trx_addons_sow_widget_yandexmap', $this);
			...
			do_action('trx_addons_action_after_widget_fields', $instance, 'trx_addons_sow_widget_yandexmap', $this);
		}
	}
