...
if ( ! function_exists( 'trx_addons_sc_slider_gutenberg_sc_params' ) ) {
	...
	function trx_addons_sc_slider_gutenberg_sc_params( $vars = array() ) {
		...
		$vars['sc_slider_controls_paginations_types'] = trx_addons_get_list_sc_slider_controls_paginations_types();

		// Titles in the Swiper
		$vars['sc_slider_titles'] = trx_addons_get_list_sc_slider_titles();

		// Styles of the slider controller
		$vars['sc_slider_controller_styles'] = trx_addons_get_list_sc_slider_controller_styles();

		// Styles of the slider controls
		$vars['sc_slider_controls_styles'] = trx_addons_get_list_sc_slider_controls_styles();
