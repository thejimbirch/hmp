<?php
/**
 * The style "default" of the Agents
 *
 * @package WordPress
...
?><div data-post-id="<?php the_ID(); ?>" class="sc_team_item">
	<?php
	// Featured image
	...
	?><div class="sc_team_item_info">
		<div class="sc_team_item_header">
			<h4 class="sc_team_item_title entry-title"><a href="<?php echo esc_url($link); ?>"><?php the_title(); ?></a></h4>
		...
		?><div class="sc_team_item_socials"><?php
			trx_addons_show_layout(trx_addons_get_socials_links_custom(trx_addons_properties_get_agent_socials($meta)));
		?></div>
